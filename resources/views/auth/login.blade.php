            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5 offset-md-4" style="margin-right: 25px">
                                <div class="form-check" >
                                    <input class="form-check-input" style="margin-right: 35px" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
